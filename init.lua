...
require("lazy").setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      vim.cmd.hi("LineNr guifg=#666666 guibg=none ctermbg=none")
      vim.cmd.hi("CursorLineNr guifg=#FF9999 guibg=none ctermbg=none gui=bold")
      vim.cmd.hi("CursorLine guibg=none ctermbg=none")
      vim.cmd.hi("Normal guibg=none ctermbg=none")
      vim.cmd.hi("ColorColumn guibg=darkred ctermbg=darkred guifg=darkred")
