...
require("lazy").setup({
	...
	require("kickstart.plugins.ampcode"),
	...
	-- 		})
	-- 		require("bamboo").load()
	-- 		vim.cmd.hi("NormalFloat guibg=yellow")
	-- 	end,
	-- },
	{
		...
		config = function()
			...
			-- vim.cmd.hi("Visual guibg=darkblue cterm=none ctermbg=white ctermfg=black gui=none guibg=yellow")
			-- vim.cmd.hi("Visual guibg=darkblue cterm=none ctermbg=white ctermfg=black guibg=darkblue")
			vim.cmd.hi("Visual cterm=none gui=none guibg=darkblue")
			vim.cmd.hi("String cterm=none gui=none")
...
-- Apply the icons via the new diagnostic config API
...
vim.api.nvim_create_autocmd("ColorScheme", {
	pattern = "*",
	callback = function()
		vim.cmd.hi("NormalFloat guibg=#e4e4cc")
	end,
})
